...
if (!isset($_SESSION["estado"])) {
    ...
    <html>
        <head>
            ...
            <script src="../js/modelos/ap_roles.js?ramdom=<?= time() ?>" type="text/javascript"></script>
            ...
            <script src="../js/vistas/permisosaroles.js?ramdom=<?= time() ?>" type="text/javascript"></script>
        </head>
        <body class="hold-transition skin-blue sidebar-mini">
            <input type="hidden" id="codprog" name="codprog" value="perm_arol" />
            <div id="container">  
                <h3>Permisos a Roles</h3>
                <div class="box-body"> 
                    <div id="mensajes" class="col-lg-12"></div>
                    <div class="form-group">
                        <label>Roles</label>
                        <div id="divListaAPRoles"></div>
                    </div>            
                    <div class="form-group">                
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="col-sm-8" id="divGrupoPermisos" ></div>
