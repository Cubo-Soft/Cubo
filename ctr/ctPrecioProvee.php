            ...
            if( !isset($_REQUEST['tmpTabla']) ){
              ...
              if( !isset( $_REQUEST['archivo'] ) ){
                ...
                if( !file_exists($_REQUEST['archivo']) ){
                  ...
                  fwrite($arch,"en ctPrecioProvee archivo: ".$_REQUEST['archivo']." OK... \n");
                  ...
                  if( $a_datos = file( $_REQUEST['archivo'] ) ){
                    ...
                    for( $x=0; $x < count($a_datos); $x++ ){
                      ...
                      $arl[4] = str_replace(",",".",$arl[4]);  // adicion reemplazo coma por punto en valor. 2025-05-02 {RMG}
                    ...
                    fwrite($arch,"Registros cargados a tabla temporal. OK !");
                  }else{
