...
$retorno["cm_trm"] = $OB_cm_trm->leer($datos, 1);
...
$OB_cotizacion->mostrarTablaEquipos($retorno,1);
...
$nombreCliente = '';
if (count($retorno["nm_juridicas"]) > 0) {
...
$nombreCotizacion = "Eq_CT_" . $retorno["vr_cotiza"][0]["nro_cot"] . "_" . $retorno["vr_cotiza"][0]["version"];
