...
if (!isset($_SESSION["estado"])) {
    ...
    ?>
        ...
        <?= retornarCabeceraInicial("Cubo") ?>
            ...
            <script src="../js/vistas/cotiza.js?ramdom=<?= time() ?>" type="text/javascript"></script>
        ...
        <body style="background-color: #C7D2CB;">
            <input type="hidden" id="codprog" name="codprog" value="cotiza" />
            ...
            <div id="container">
                ...
                <?php
                $datos["texto"] = "Esta usted en el módulo de <strong>Cotización de repuestos</strong>";
                $datos["trm"] = $trm;
                $datos["titulo"]="Existencias en otras bodegas";
                $textoApoyo='<div class="col-lg-12"><center><strong>Cotización</strong></center></div><br/>';
