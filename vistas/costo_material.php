...
$ar_costelem = $tcostelem->lee(" ORDER BY id_material,id_elemen,id_complem,id_diametro");
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<form name='Interface' method='post' onkeypress='return anular(event)' enctype='multipart/form-data'>
      ...
      <table class="table table-striped table-hover table-bordered table-sm table-responsive-sm caption-top tabla1">
        <tbody> 
            ...
            <tr>
              <td colspan='<?php echo $totcampos ?>'>
              <div class='row fondo_negro'>
                <div class='col-sm-5 letras_blancas' ><H3><?php echo $tabla->titTabla ?></H3> </div>
            ...
            <tr>
              <?php
                  echo "<th colspan='".$totcampos."' style='text-align:center;font-size:15px;background-color:#172D8D;'><span class='blanco'> Material  </span> ";
  ...
  <script src="../js/vistas/costo_material.js"></script>  
</body>
</html>