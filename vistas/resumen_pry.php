...
$tiplineas   = new Tabla($odb,"ip_lineas");
...
$sql_ciud = "SELECT c.id_ciudad,c.nom_ciudad,c.id_pais, d.*, p.nom_pais FROM `np_ciudades` c left outer join np_deptos d on d.id_dpto = c.id_dpto left outer join np_paises p on p.id_pais = c.id_pais ORDER BY c.nom_ciudad,c.id_ciudad;"; 
$ar_ciu = $tnpciudades->ejec($sql_ciud,"S","A");
$ro_trm = $ro_iva = " readonly ";
//echo "<pre>";print_r($_SESSION);echo "</pre>"; //exit;
if( $_SESSION['id_rol'] < 3 ){ $ro_iva = ""; }
if(!isset($_REQUEST['ctro_costo'])){
  ...
  <body>   
    <div style="width:30%;border: .5pt solid;margin-left: 20pt;margin-top: 15pt">
      <B style="margin: lef 15pt;font-size:medium">RESUMEN DE PROYECTO</B>
      <form method='POST'>
          <label for="">Centro de Costo del Proyecto:</label>
          <select name="ctro_costo" class="form-select form-select-lg" onblur="validaCtro(this);">
              <option value="">Sin elegir</option>
              <?php
...
<body>
  <B class="encab" id="Inicio" style="font-size:large">RESUMEN DE PROYECTO</B>
<div class="container" id="resumen" style="margin-left:5pt;display:block;">
  <table style="width:520pt">
      ...
      <tr style='border:0.5px solid'>
        ...
        <td class=xl137 style='border-left:none' colspan="2"> 
            <select name="ciudad" id="ciudad" >
                <?php
                  for($x=0; $x < count( $ar_ciu); $x++){
                    $sel = "";
                    if( $ar_ciu[$x]['id_ciudad'] == $ar_pry['cod_ciu_ori']){$sel = " selected ";}
                    $tit = $ar_ciu[$x]['nom_pais'];
                    echo "<option value='".$ar_ciu[$x]['id_ciudad']."' title='".$tit."' $sel >".$ar_ciu[$x]['nom_ciudad']." ( ".$ar_ciu[$x]['nom_dpto']." )</option>";
                  }
                ?>
            </select>
          </td>
      ...
      <tr style='height:13.95pt'>
        <td colspan=4 class=xl227 style='border-right:.5pt solid '>&nbsp;CIUDAD PROYECTO</td>
        <td colspan=4 class=xl85 style='border-left:none'>
            <select name="codciu_proy" id="codciu_proy" >
                <?php
                  for($x=0; $x < count( $ar_ciu); $x++){
                    $sel = "";
                    if( $ar_ciu[$x]['id_ciudad'] == $ar_pry['codciu_proy'] ){$sel = " selected ";}
                    $tit = $ar_ciu[$x]['nom_pais'];
                    echo "<option value='".$ar_ciu[$x]['id_ciudad']."' title='".$tit."' $sel >".$ar_ciu[$x]['nom_ciudad']." ( ".$ar_ciu[$x]['nom_dpto']." )</option>";
                  }
                ?>
      ...
      <tr style='height:13.95pt'>
        ...
        <td colspan=1 class=xl85 style='border-left:none'> 
              <input type='text' name='ctro_costo' id='ctro_costo' value='<?php echo $_REQUEST['ctro_costo'] ?>' style="width:99.9%;" readonly>
        </td>
        <td class=xl227 style='border-right:.5pt solid;text-align:right;'>SUB - LÍNEA &nbsp;</td>
        <td colspan=2 class=xl85 style='border-left:none'>
            <select name="idsublinea" id="idsublinea" class='form-select form-select-lg' style="width:99.9%;">
                <?php 
                for($x=0; $x < count( $ar_lineas); $x++){
                  if( $ar_lineas[$x]['nivel'] == 1){
                    echo '<optgroup label="'.$ar_lineas[$x]['descrip'].'">';
                  }else{
                    $sel = "";
                    if( $ar_lineas[$x]['id_linea'] == $ar_pry['sublinea'] ){ $sel = " selected ";}
                    echo '<option value="'.$ar_lineas[$x]['id_linea'].'" '.$sel.'>'.$ar_lineas[$x]['descrip'].' </option>';
                  } 
      ...
      <tr height=18 style='height:13.95pt'>
        ...
        <td colspan=4 class=xl227 style='height:18pt;border-right:.5pt solid'>
          <div style="width:200px;float:left;height:18pt;">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IVA %&nbsp;
              <input type='text' name='iva' id='iva' value='<?php echo $ar_pry['iva_proy'] ?>' <?php echo $ro_iva ?>
                      class="valor" size="8" style="color:black">
              <input type='hidden' name='iva_x' id='iva_x' value='<?php echo ($ar_pry['iva_proy']) ?>' >
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TRM&nbsp;
              <input type='text' name='trm' id="trm" value='<?php echo fpesos($ar_pry['trm_proy']) ?>' <?php echo $ro_trm ?>
                      class="valor" size="10" style="color:black" >
              <input type='hidden' name='trm_x' id="trm_x" value='<?php echo $ar_pry['trm_proy'] ?>' style="color:black" >
          </div>
        </td>
      </tr>
    </table>
    ...
    <table style="width:520pt;border:.5pt solid;">  
      <tr style='height:20pt;'>
        ...
        <td style='width:80pt'>&nbsp;</td>
        <td style='width:117pt'>&nbsp;</td>
        <td style='width:117pt;padding:5pt;'>&nbsp;
        ...
        <td style='width:82pt;padding:5pt;'>   
              <button id="idpdf_gral"  style="display:block">
                <img src="../img/adobe_file_pdf_type_icon.svg" width="20pt" title="PDF V.General"> 
              </button>
        </td>
      </tr>
      ...
      <tr height=18 style='height:13.8pt'>
        ...
        <td class=xl148 style='text-align:right'>
            USD<input type='text' name='ustotpersalfrio' id="ustotpersalfrio" size='12' class="valor" readonly>  
        </td>
    ...
    <table style="border:.5pt solid;width:520pt">  
      <tr style='height:20pt;'>
        ...
        <td style='width:82pt;padding:5pt;'>
            <button id="idpdf_clie" style="display:block">
              <img src="../img/adobe_file_pdf_type_icon.svg" width="20pt" title="PDF V.Cliente">
            </button>
        </td>
      </tr>
  ...
  <div class="container" id="costos_adm" style="display:none;margin-left:5pt">
    <div style="display:inline;font-size:medium" id="nom_proy_admtvo" > </div>
    <table cellspacing=0  style='border-collapse:collapse;padding:0'> 
...
<div class="container" id="costos_pers_alfrio" style="display:none;margin-left:5pt">
    <div style="display:inline;font-size:medium" id="nom_proy_pers" > </div>
    <table style='width:400pt;padding:0;border-collapse:collapse;background-color:lightgray;'> 
      <tr height=19 style='height:14.4pt;display:none'>
    ...
    <table cellspacing=0 style='width:610px;border-collapse:collapse;padding:0;'>
      <tr style='height:20pt;'>
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl235 style='border-left:none'>Personas</td>
      ...
      <tr height=18 style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            ...
            onblur="autPersonas(this)" >
        </td>

        <td class=xl202 style='text-align:center'> 
            <input type="text" name="peringe" id="peringe" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[0]['personas'])){echo $ar_pers[0]['personas'];}else{ echo "";}; ?>" 
            onblur="multi($('#caninge'),'id_020101','csttotinge','totmanoinge','','');">
        </td>

        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="cstinge" id="id_020101" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
            <input type="text" name="csttotinge" id="csttotinge" style="width:92%" class="valor" readonly > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="cantecn" id="cantecn" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[1]['cant'])){echo $ar_pers[1]['cant'];}else{echo "";} ?>" 
              onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="pertecn" id="pertecn" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[1]['personas'])){echo $ar_pers[1]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#cantecn'),'id_020201','csttottecn','totmanotecn','','');">
        </td>

        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csttecn" id="id_020201" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="csttottecn" id="csttottecn" style="width:92%" class="valor" readonly 
            > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="cantiqinge" id="cantiqinge" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[2]['cant'])){echo $ar_pers[2]['cant'];}else{echo "";} ?>" 
              onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="pertiqinge" id="pertiqinge" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[2]['personas'])){echo $ar_pers[2]['personas'];}else{echo "";} ?>" 
              onblur="multi($('#cantiqinge'),'id_020301','tottiqinge','totviatinge','inge');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csttiqinge" id="id_020301" style="width:92%" class="valor" readonly>
        </td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="tottiqinge" id="tottiqinge" style="width:92%" class="valor" readonly > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="canhosinge" id="canhosinge" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[3]['cant'])){echo $ar_pers[3]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="perhosinge" id="perhosinge" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[3]['personas'])){echo $ar_pers[3]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#canhosinge'),'id_020302','tothosinge','totviatinge','inge');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csthosinge" id="id_020302" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
            <input type="text" name="tothosinge" id="tothosinge" style="width:92%" class="valor" readonly  > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="canaliinge" id="canaliinge" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[4]['cant'])){echo $ar_pers[4]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="peraliinge" id="peraliinge" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[4]['personas'])){echo $ar_pers[4]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#canaliinge'),'id_020303','totaliinge','totviatinge','inge');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="cstaliinge" id="id_020303" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
            <input type="text" name="totaliinge" id="totaliinge" style="width:92%" class="valor" readonly > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
          <input type="text" name="cantrainge" id="cantrainge" style="width:92%" class="centro" 
          value="<?php if(isset($ar_pers[5]['cant'])){echo $ar_pers[5]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
          <input type="text" name="pertrainge" id="pertrainge" style="width:92%" class="centro" 
          value="<?php if(isset($ar_pers[5]['personas'])){echo $ar_pers[5]['personas'];}else{echo "";} ?>"  
          onblur="multi($('#cantrainge'),'id_020304','tottrainge','totviatinge','inge');">
        </td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csttrainge" id="id_020304" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
            <input type="text" name="tottrainge" id="tottrainge" style="width:92%" class="valor" readonly > 
      ...
      <tr height=18 style='height:13.8pt'>
        ...
        <td class=xl193 style='border-top:none'>Tiquetes (Ida y Regreso) x persona</td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="cantiqtecn" id="cantiqtecn" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[6]['cant'])){echo $ar_pers[6]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="pertiqtecn" id="pertiqtecn" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[6]['personas'])){echo $ar_pers[6]['personas'];}else{echo "";} ?>" 
              onblur="multi($('#cantiqtecn'),'id_020401','tottiqtecn','totviattecn','tecn');">
        </td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csttiqtecn" id="id_020401" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="tottiqtecn" id="tottiqtecn" style="width:92%" class="valor" readonly > 
      ...
      <tr height=18 style='height:13.8pt'>
        ...
        <td class=xl193 style='border-top:none'>Hospedaje x noche x persona</td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="canhostecn" id="canhostecn" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[7]['cant'])){echo $ar_pers[7]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="perhostecn" id="perhostecn" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[7]['personas'])){echo $ar_pers[7]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#canhostecn'),'id_020402','tothostecn','totviattecn','tecn');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csthostecn" id="id_020402" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="tothostecn" id="tothostecn" style="width:92%" class="valor" readonly > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl193 style='border-top:none'>Alimentación x día x persona</td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="canalitecn" id="canalitecn" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[8]['cant'])){echo $ar_pers[8]['cant'];}else{echo "";} ?>" 
              onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="peralitecn" id="peralitecn" style="width:92%" class="centro" 
              value="<?php if(isset($ar_pers[8]['personas'])){echo $ar_pers[8]['personas'];}else{echo "";} ?>" 
              onblur="multi($('#canalitecn'),'id_020403','totalitecn','totviattecn','tecn');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="cstalitecn" id="id_020403" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="totalitecn" id="totalitecn" style="width:92%" class="valor" readonly > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="cantratecn" id="cantratecn" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[9]['cant'])){echo $ar_pers[9]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="pertratecn" id="pertratecn" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[9]['personas'])){echo $ar_pers[9]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#cantratecn'),'id_020404','tottratecn','totviattecn','tecn');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csttratecn" id="id_020404" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="tottratecn" id="tottratecn" style="width:92%" class="valor" readonly > 
      ...
      <tr height=18 style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="cantragara" id="cantragara" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[10]['cant'])){echo $ar_pers[10]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="pertragara" id="pertragara" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[10]['personas'])){echo $ar_pers[10]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#cantragara'),'id_020501','tottragara','totgarantias','gara');">
        </td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="csttragara" id="id_020501" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="tottragara" id="tottragara" style="width:92%" class="valor" readonly > 
      ...
      <tr style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="cansuegara" id="cansuegara" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[11]['cant'])){echo $ar_pers[11]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="persuegara" id="persuegara" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[11]['personas'])){echo $ar_pers[11]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#cansuegara'),'id_020502','totsuegara','totgarantias','gara');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="cstsuegara" id="id_020502" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="totsuegara" id="totsuegara" style="width:92%" class="valor" readonly > 
      ...
      <tr height=18 style='height:13.8pt'>
        ...
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="canviagara" id="canviagara" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[12]['cant'])){echo $ar_pers[12]['cant'];}else{echo "";} ?>" 
            onblur="autPersonas(this)" >
        </td>
        <td class=xl202 style='text-align:center'> 
            <input type="text" name="perviagara" id="perviagara" style="width:92%" class="centro" 
            value="<?php if(isset($ar_pers[12]['personas'])){echo $ar_pers[12]['personas'];}else{echo "";} ?>" 
            onblur="multi($('#canviagara'),'id_020503','totviagara','totgarantias','gara');"></td>
        <td class=xl194 style='text-align:rigth'>$ <input type="text" name="cstviaalfr" id="id_020503" style="width:92%" class="valor" readonly></td>
        <td class=xl194 style='text-align:rigth'>$ 
          <input type="text" name="totviagara" id="totviagara" style="width:92%" class="valor" readonly > 
      ...
      <tr style='height:13.8pt'>
        <td colspan=3 style='height:13.8pt;'></td>
        <td class=xl141></td>
        <td class=xl141></td>
        <td></td>
      </tr>
...
<div class="container" id="costo_instal_equipos" style="display:none;margin-left:0pt;overflow:auto;width:100%;height:100%;padding:0;"> <!-- width:100%; -->
  <div style="display:inline;font-size:medium" id="nom_proy_equipos"> </div>
  ...
  <table style="border-collapse:collapse;background-color:lightgray;" id="tb_cst_equipos">
    ...
    <tr height=18 style='height:13.95pt'>
      ...
      <td  colspan=2 class=xl109 >$ 
          <input type="text" id="totCostSoport" style="width:95%" class="valor" readonly>
          <input type="hidden" id="totCostSoport_x" >
      </td>
      <td></td>
 ...
 <div id="cuerpoInsEquipos" style="width:100%;margin-bottom:10px"> <!-- display:flex;overflow-y:auto; -->
  ...
  <div id="" style="width:99%;">    
    <!-- sección captura y arreglo instalación equipos -->
    <table style='border-color:aliceblue;' >  
      ...
      <tr style='height:20pt;display:none;'>
        ...
        <td > <input type="hidden"  id="id_contador" value="0" ></td>
        <td > <input type="hidden"  id="sm_costInstal" ></td>
        <td > <input type="hidden"  id="sm_costAislam" >
      ...
      <tr style='height:13.8pt;background:#D9E1F2;'>
        ...
        <td class=xl108 >
            ...
            <td>
                <button title="Borrar" id="borra_equipos">x</button>
                <button title="Salvar Valores" id="salva_equipos">s</button>
            </td>
      </tr>
    </table>
    <!-- capa de arreglo de inst. equipos -->
    <!-- <div id="divRegistrosInstEq" style="margin-left:0; background-color:burlywood">  -->
        <table style='border-collapse:collapse;border:0.01pt solid;margin-left:0;padding-left:0;' id="idTablaLineas" > <!-- float:left; -->
          <thead>     
            <tr style='height:13.8pt;'>
              <td class=xl104 style="width:220px;text-align:center">Equipo</td>
  ...
  <br>
  <div id="divSoportEquipos" style="width:80%;top:10px;">
      <br>
      <table style='border-collapse:collapse;margin-left:1px;' id="idTablaSoporteria" >  
        <thead>     
          <tr style='height:13.8pt;'>
          ...
          <tr style='height:10pt;'>
            ...
            <td class=xl246 style="width:62px;">Mat x Sop(mts)</td>
            <td class=xl246 style="width:65px;">Cant Sop(unidad)</td>
        ...
        <tbody id="cuerpoEntrada2">
          <tr>
            <td> <?php echo $tgp_perfils->selecc('perfil_0','','','','|'); ?> </td> 
            ...
            <td>
                <button title="Borra Soporteria Equipos" id="borra_sop_equipos">x</button>
                <button title="Salva Soporteria Equipos" id="salva_sop_equipos">s</button>
            </td>
          </tr>
        </tbody>         
      </table>
      ...
      <div>
          <table style='border-collapse:collapse;margin-left:1px;border:0.01pt solid;' id="idTablaSoporteria" >   
            <thead> 
              <tr style='height:13.8pt;'>
                <td class=xl246 style="width:85px;">Perfil</td>
                <td class=xl246 style="width:62px;">Mat x Sop(mts)</td>
...
<div style="display:inline;font-size:medium" id="nom_proy_tuberia"> </div>
...
<div  style="display:flex;width:100%;overflow-y:auto">
  ...
  <div style="width:25%;float:right;">
    ...
    <div style="padding:13px">
        <button type='button' class='btn btn-primary btn-sm' id="xcosto_instal_tuberia" >
          Regresar
        </button>
    </div>
...
<div id="divInsTuberia" style="width:100%;overflow-y:auto"> <!-- display:flex; -->
      <div  style="width:100%;">  <!-- div presentación y captura registros tuberia  -->
        <table cellspacing=0  style='border-collapse:collapse;padding:0'> 
        <tr style='height:13.95pt'>
        ...
        <tr style='height:4pt'> 
          ...
          <td >
                <button title="Borra valores Tuberia" id="borra_tuberia">x</button>
                <button title="Salva Valores Tuberia" id="salva_tuberia">s</button>
          </td>
        </tr>
      ...
      <div id="divSoporteriaTuberia" style="width:60%;">
        <!-- div captura y presentación soporteria tuberia -->
      <table style='border-collapse:collapse;margin-left:10px;' id="idTablaSoporteria">   
            <thead>     
              ...
              <tr style='height:13.8pt;'>
                  ...
                  <td class=xl246 style="width:62px;">Mat x Sop(mts)</td>
                  <td class=xl246 style="width:62px;">Cant Sop(unidad)</td>
            ...
            <tbody id="cuerpoEntrada3">
              <tr>
                  ...
                  <td> <input type="text" name="matSop_1" id="matSop_1" style="width:99%" class="valor"> </td>
                  <td> <input type="text" name="canSop_1" id="canSop_1" style="width:99%" class="valor" onblur="calcPerfil(this);"> </td>
                  <td> 
                      <input type="text" name="cstMaterial_1" id="cstMaterial_1" style="width:99%" class="valor" readonly><br>
                      <input type="hidden" id="vrMaterial_1" >
                  </td>
                  <td> <input type="text" name="cstMobra_1" id="cstMobra_1" style="width:99%" class="valor" readonly><br>
                       <input type="hidden" id="vrMobra_1"  > 
                  </td>
                  <td> <input type="text" name="cstPintura_1" id="cstPintura_1" style="width:99%" class="valor" readonly><br>
                       <input type="hidden"  id="vrPintura_1"  > 
                  </td>
                  <td>
                      <button title="Borrar Soporteria Tuberia" id="borra_sop_tuberia">x</button>
                      <button title="Salvar Soporteria Tuberia" id="salva_sop_tuberia" >s</button>
                  </td>
              </tr>
            </tbody>         
        </table>
        ...
        <div style="width:100%"> <!-- capa de arreglo soporteria instal. tuberia -->
            <table style='border-collapse:collapse;margin-left:10px;border:0.01pt solid;' id="idTablaSoporteria" >   
              <thead> 
                <tr style='height:13.8pt;'>
                    <td class="xl246" style="width:88px;">Perfil</td>
                    <td class="xl246" style="width:62px;">Mat x Sop(mts)</td>
...
<div class="container" id="costo_instal_valvula" style="display:none; margin-left:5pt">
  <div style="display:inline;font-size:medium" id="nom_proy_valvulas"> </div>
  ...
  <div  style="width:10%;text-align:left;margin-left:370px;padding:5px;">
  ...
  <table>
    ...
    <tr>
      ...
      <td>
          <button title="Borra valores Válvulas" id="borra_valvulas">x</button>
          <button title="Salva Valores Válvulas" id="salva_valvulas">s</button>

      </td>
    </tr>
  </table>
  <div id="regInsValv" style="display:block">
    <table border=1 cellspacing=3 style='margin-left:10pt;border-collapse:collapse;'> 
      <thead>
        <tr style='height:13.8pt'>
...
<div class="container" id="costo_instal_electrica" style="display:none; margin-left:5pt">
  <div style="display:inline;font-size:medium" id="nom_proy_electrica"> </div>
  ...
  <div id="idresumen_electrica">
      <table style='border-collapse:collapse;background-color:lightgray;'>  
        ...
        <tr style='height:13.95pt'>
          ...
          <td class=xl109 style='border-top:none;border-left:none'>$
              <input type="text" id="totCstSopBandej" style="width:88%" class="valor" readonly>
              <input type="hidden" id="totCstSopBandej_x">
          </td>
        </tr>
        <tr style='height:13.8pt'>
          <td style='height:13.8pt'></td>
    ...
    <div  style="width:10%;margin-left:450px;padding:5px;">
        <button type='button' class='btn btn-primary btn-sm' id="xcosto_instal_electrica" title="Guardar cambios Válvulas">Regresar</button>
    </div>
    
  <div id="idcosto_electrico_padre" style="width:90%;">
      <div id="idcosto_electrico_equipos" style="width:100%;top:0px;left:0px;padding:0px;margin-bottom:10px;"> <!-- float:left; -->
        <table cellpadding=0 cellspacing=0 style='margin-left:0pt;border-collapse:collapse;'>  
          ...
          <tr>
            ...
            <td> 
                <button title="Borrar" id="borra_eqElect">x</button>
                <button title="Salvar Valores" id="salva_eqElect">s</button>
            </td>
          </tr>    
          <tr style="display:none">
            <td></td>
      ...
      <div id="idcosto_electrico_bandejas" style="width:90%;padding-top:5px;"> <!-- float:left; -->
        ...
        <table cellpadding=0 cellspacing=0 style='margin-left:0pt;border-collapse:collapse;'> 
          ...
          <tr>
            ...
            <td>
                <button title="Borrar" id="borra_tbElect">x</button>
                <button title="Salvar Valores" id="salva_tbElect">s</button>
            </td>
          </tr>
      ...
      <div id="idcosto_electrico_soporteria" style="width:100%;padding-top:10px;padding-bottom:10px;">
        <!-- INICIO div soporteria instal. electrica -->
        <table style='border-collapse:collapse;margin-top:10px;' id="idTablaSoporteriaElectrica" > 
            <thead>     
            <tr style='height:13.8pt;'>
                    <td colspan="3" class="xl246" >SOPORTE</td>
                    <td colspan="3" class="xl247" style="width:360px;">COSTO</td>
                ...
                <tr style='height:13.8pt;'>
                    ...
                    <td class=xl246 style="width:62px;">Mat x Sop(mts)</td>
                    <td class=xl246 style="width:65px;">Cant Sop(unidad)</td>
                    <td class=xl247 style="width:120px;">Material</td>
                    <td class=xl247 style="width:120px;">M.Obra</td>
                    <td class=xl247 style="width:120px;">Pintura</td>
                    <td style="width:10px"></td>
                </tr>  
            </thead>
            <tbody id="cuerpoEntrada4">
                <tr>
                  <td> <?php echo $tgp_perfils->selecc('perfil_2','','','','|','width:99%'); ?> </td>
                  <td> <input type="text" name="matSop_2" id="matSop_2" style="width:99%" class="valor"> </td>
                  <td> <input type="text" name="canSop_2" id="canSop_2" style="width:99%" class="valor" onblur="calcPerfil(this);"> </td>
                  <td> 
                      <input type="text" name="cstMaterial_2" id="cstMaterial_2" style="width:99%" class="valor" readonly><br>
                      <input type="hidden" id="vrMaterial_2"  >
                  </td>
                  <td> <input type="text" name="cstMobra_2" id="cstMobra_2" style="width:99%" class="valor" readonly><br>
                       <input type="hidden" id="vrMobra_2" > 
                  </td>
                  <td> <input type="text" name="cstPintura_2" id="cstPintura_2" style="width:99%" class="valor" readonly><br>
                       <input type="hidden"  id="vrPintura_2"  > 
                  </td>
                  <td>
                      <button title="Borrar " id="borra_sop_elec">x</button>
                      <button title="Salvar Valores Soporteria Eléctricos" id="salva_sop_elec" >s</button>
                  </td>
                </tr>
            </tbody>         
        </table>
...
<div class="container" id="costo_pruebas" style="display:none; margin-left:5pt">
  <div style="display:inline;font-size:medium" id="nom_proy_pruebas"> </div>
  <input type="hidden" name="hay_pruebas" id="hay_pruebas" size="1" value="<?php echo $hay_pruebas ?>" readonly>
  <table cellpadding="0" cellspacing="0" style='border-collapse:collapse;width:351pt;background-color:lightgray;'>  
    <tr height=19 style='height:14.4pt;display:none'>
...
<table style='border-collapse:collapse;width:606pt;padding:0'>
    <tr style='height:13.8pt'>
      <td colspan=8 >
          <!-- <div style="display:flex;width:50%"> -->
            <div  style="width:10%;margin-left:350px;padding:5px">
    ...
    <tr style='height:13.8pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="canDias_pre" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070101" class="valor" onblur="leeCantPrb($('#canDias_pre'),'id_070101','tot_Presion','canPers_pre')"> </td>
    ...
    <tr style='height:13.95pt'>
      ...
      <td class=xl87 ><input type="text" style="width:90%" id="canDias_RX" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070102" class="valor" onblur="leeCantPrb($('#canDias_RX'),'id_070102','tot_PruebaRX','canPers_RX')"> </td>
      <td  class="xl109 valor">$
    ...
    <tr style='height:13.95pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="canDias_Triple" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070103" class="valor" onblur="leeCantPrb($('#canDias_Triple'),'id_070103','tot_Triple','canPers_Triple')"> </td>
      <td  class="xl109 valor">$
    ...
    <tr style='height:13.95pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="canDias_PrueElec" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070104" class="valor" onblur="leeCantPrb($('#canDias_PrueElec'),'id_070104','tot_PrueElec','canPers_PrueElec')"> </td>
      <td  class="xl109 valor">$
    ...
    <tr style='height:13.8pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="cant_Nitrogeno" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070201" class="valor" onblur="leeCantPrb($('#cant_Nitrogeno'),'id_070201','tot_Nitrogeno','')"> </td>
      <td  class="xl109 valor">$
    ...
    <tr style='height:13.8pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="cant_Soldadura" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070202" class="valor" onblur="leeCantPrb($('#cant_Soldadura'),'id_070202','tot_Soldadura','')"> </td>
      <td  class="xl109 valor">$
    ...
    <tr style='height:13.8pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="cant_Alquiler" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070203" class="valor" onblur="leeCantPrb($('#cant_Alquiler'),'id_070203','tot_Alquiler','')"> </td>
      <td  class="xl109 valor">$
    ...
    <tr style='height:13.8pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="cant_TranspMtr" class="valor"></td>
      <td class=xl109>$<input type="text" style="width:90%" id="id_070204" class="valor" onblur="leeCantPrb($('#cant_TranspMtr'),'id_070204','tot_TranspMtr','')"> </td>
      <td  class="xl109 valor">$
    ...
    <tr style='height:13.8pt'>
      ...
      <td class=xl87><input type="text" style="width:90%" id="cant_Consumib" class="valor" ></td> 
...
<div class="container" id="costo_varios" style="display:none; margin-left:5pt">
  <div style="display:inline;font-size:medium" id="nom_proy_varios"> </div>
...
<tr  style='height:13.8pt'>
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class="xl69 valor">
          <input type="text" id="idseccAndam_1" style="width:85%" class="valor"></td>
      <td class="xl69 valor"><input type="text" id="id_080401" style="width:85%" class="valor" onblur="cstAndamios($('#idseccAndam_1'),'iddiasAndam_1','id_080401','idcostAndam_1');" ></td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class="xl69 valor" > 
          <input type="text" id="idseccAndam_2" style="width:85%" class="valor"></td>
      <td class="xl112 valor"> <input type="text" id="id_080402" style="width:85%" class="valor" onblur="cstAndamios($('#idseccAndam_2'),'iddiasAndam_2','id_080402','idcostAndam_2');" > </td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl69 ><input type="text" id="can_Cont_1" style="width:85%" class="valor" ></td>
      <td class=xl112 >$ <input type="text" id="id_080501" style="width:85%" class="valor" onblur="cst1($('#can_Cont_1'),'id_08050','idCst');" > </td>  <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl69 ><input type="text" id="can_Cont_2" style="width:85%" class="valor" ></td>
      <td class=xl112 >$ <input type="text" id="id_080502" style="width:85%" class="valor" onblur="cst1($('#can_Cont_2'),'id_08050','idCst');" > </td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl69 ><input type="text" id="can_Cont_3" style="width:85%" class="valor" ></td>
      <td class=xl112 >$ <input type="text" id="id_080503" style="width:85%" class="valor" onblur="cst1($('#can_Cont_3'),'id_08050','idCst');" > </td>  <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 ><input type="text" id="can_Viat_1" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080601" style="width:85%" class="valor" onblur="cst1($('#can_Viat_1'),'id_08060');" > </td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 ><input type="text" id="can_Viat_2" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080602" style="width:85%" class="valor" onblur="cst1($('#can_Viat_2'),'id_08060');" > </td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 ><input type="text" id="can_Viat_3" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080603" style="width:85%" class="valor" onblur="cst1($('#can_Viat_3'),'id_08060');" > </td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 ><input type="text" id="can_Viat_4" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080604" style="width:85%" class="valor" onblur="cst1($('#can_Viat_4'),'id_08060');" > </td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 ><input type="text" id="cant_Persi_1" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080701" style="width:85%" class="valor" onblur="cst1($('#cant_Persi_1'),'id_08070');" > </td> <!-- readonly -->
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 ><input type="text" id="cant_Persi_2" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080702" style="width:85%" class="valor" onblur="cst1($('#cant_Persi_2'),'id_08070');" > </td>
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 ><input type="text" id="cant_Persi_3" style="width:85%" class="valor"></td>
      <td class=xl184 >$ <input type="text" id="id_080703" style="width:85%" class="valor" onblur="cst1($('#cant_Persi_3'),'id_08070');" > </td>
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 > <input type="text" id="cant_Persi_4" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080704" style="width:85%" class="valor" onblur="cst1($('#cant_Persi_4'),'id_08070');"> </td>
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 > <input type="text" id="cant_Persi_5" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080705" style="width:85%" class="valor" onblur="cst1($('#cant_Persi_5'),'id_08070');"> </td>
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 > <input type="text" id="cant_Resid_1" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080801" style="width:85%" class="valor" onblur="cst1($('#cant_Resid_1'),'id_08080');"> </td>
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 > <input type="text" id="cant_Resid_2" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080802" style="width:85%" class="valor" onblur="cst1($('#cant_Resid_2'),'id_08080');"> </td>
    ...
    <tr  style='height:13.8pt'>
      ...
      <td class=xl183 > <input type="text" id="cant_Resid_3" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080803" style="width:85%" class="valor" onblur="cst1($('#cant_Resid_3'),'id_08080');"> </td>
    ...
    <tr style='height:13.8pt'>
      ...
      <td class=xl183 > <input type="text" id="cant_Banos_1" style="width:85%" class="valor" ></td>
      <td class=xl184 >$ <input type="text" id="id_080901" style="width:85%" class="valor" onblur="cst1($('#cant_Banos_1'),'id_08090');"> </td>
