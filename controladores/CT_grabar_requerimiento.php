...
try {
    ...
    */
    ...
    if ($asesorZona === '-1' || is_null($asesorZona)) {
        ...
        id_requerim, id_fuente, fechora, nom_cliente, nit_cliente, suc_cliente, id_contacto, grupo,
        de_linea, asesor_asignd, observs, estado, cod_grabador, area, cod_trans, clien_provis
    ) VALUES (
        null, :id_fuente, :fechora, :nom_cliente, :nit_cliente, :suc_cliente, :id_contacto, :grupo,
    ...
    $preparacion->bindParam(':fechora', $fechora);
