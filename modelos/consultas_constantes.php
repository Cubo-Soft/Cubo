...
define("GRUPONITS1", "SELECT nm_juridicas.numid,nm_juridicas.razon_social,nm_sucursal.id_sucursal,nm_sucursal.telefono,nm_sucursal.direccion,nm_sucursal.ciudad,nm_sucursal.pais FROM nm_juridicas,nm_sucursal WHERE nm_juridicas.numid=nm_sucursal.numid  ");
