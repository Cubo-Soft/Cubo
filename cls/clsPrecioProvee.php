...
class clsPrecioProvee extends Tabla {
  ...
  public function act_precio($Otmp_Precios,$fechaCarga,$id_moneda){
    ...
    $sql .=" '$id_moneda' AS id_moneda, id_marca FROM ".$Otmp_Precios->nomTabla;
    //echo "SQL: ".$sql."<br>";
    $a_nprecios = $Otmp_Precios->ejec($sql,"S","A");
