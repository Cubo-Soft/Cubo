...
//echo "<pre>";print_r($ar_ciudades);echo "</pre>";exit;
            ...
            <select name="ciudad" id="ciudad" >
                <?php
                  for($x=0; $x < count( $ar_ciu); $x++){
                    $sel = "";
                    if( $ar_ciu[$x]['id_ciudad'] == "11001"){$sel = " selected ";}
      ...
      <table style='border-collapse:collapse;margin-left:10px;' id="idTablaSoporteria">   
            ...
            <tbody id="cuerpoEntrada3">
              <tr>
                  ...
                  <td> 
                      <input type="text" name="cstMaterial_1" id="cstMaterial_1" style="width:95%" class="valor" readonly><br>
